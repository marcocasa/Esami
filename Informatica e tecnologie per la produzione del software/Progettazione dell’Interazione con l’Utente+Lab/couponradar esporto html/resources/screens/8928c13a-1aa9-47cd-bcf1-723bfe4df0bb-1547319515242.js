jQuery("#simulation")
  .on("click", ".s-8928c13a-1aa9-47cd-bcf1-723bfe4df0bb .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/204408b9-3022-44ae-9b3e-fe98ea58a65c"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
    ...
    } else if(jFirer.is("#s-Rettangolo_per_evento")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Rectangle_1","#s-Image_103" ],
                    "effect": {
                      "type": "puff",
                      "easing": "easeInQuint",
                      "duration": 500
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Rettangolo_per_evento" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
