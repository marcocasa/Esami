jQuery("#simulation")
  .on("click", ".s-6e58cd6c-d30c-498a-9e7b-503ad60ae464 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Ellipse_23")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Rectangle_5","#s-Message-light" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Rectangle_5","#s-Message-light_1" ],
                    "effect": {
                      "type": "puff",
                      "easing": "linear",
                      "duration": 500
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Rectangle_5","#s-Button_12" ],
                    "effect": {
                      "type": "fade",
                      "easing": "linear",
                      "duration": 200
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Rectangle_5","#s-Button_4" ],
                    "effect": {
                      "type": "fade",
                      "duration": 200
                    }
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Rectangle_5","#s-Button_10" ],
                    "effect": {
                      "type": "fade",
                      "duration": 200
                    }
  ...
  .on("focusin", ".s-6e58cd6c-d30c-498a-9e7b-503ad60ae464 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-6e58cd6c-d30c-498a-9e7b-503ad60ae464 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
