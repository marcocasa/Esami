jQuery("#simulation")
  .on("click", ".s-13b49caa-32d9-4d6a-a693-99c86f3c6bca .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-tap-button")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/18209a6a-a252-4318-b9c6-acff5b4f88d4",
                    "transition": {
                      "type": "fliphorizontal",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/3f9c4093-b490-408b-8c2c-2cc7eaf9b10d"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
